...
$query = $con->query("INSERT INTO combotratamientos SET cbt_idCombo='$IDCombo', cbt_idTratamiento='$tratamiento', cbt_precio='$precio'");
if($query){
?>
	<script>$('#msj-comboTratamiento').html('<div class="contenedorAlerta"><input type="radio" id="alertExito"><label class="alerta exito" for="alertExito"><div>Se ha guardado con exito.</div><div class="close">&times;</div></label></div>');</script>
<?php
} else {
?>
