...
<form class="form" id="formReporteRips" method="post" action="reporte-rips-excel.php">
	<div class="modal-body">
		<div class="divForm">
			<div class="contenedorCheckbox SliderSwitch pointer">
				<label for="switch">Citas cumplidas
					<input id="switch" type="checkbox" name="cumplidas" value="1" checked>
...
<script>validar('#formReporteRips');</script>