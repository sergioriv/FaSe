	...
	function validar(formulario){
		$(formulario).validate({
			...
			rules: {
				...
				identificacion: { required: true, minlength: 6 },
				correo: { email: true },
				correoReq: { required: true, email: true },
				tarjeta: { required: true },
				sucursal: { required: true },
				anio: { required: true },
				mes: { required: true },
				defecha: { required: true },
				hastafecha: { required: true },
				horarioDe: { required: true },
				horarioHasta: { required: true },
				nombreEmp: { required: true },
				nitEmp: { required: true },
				codigoEmp: { required: true },
				ciudadEmp: { required: true },
				direccionEmp: { required: true },
				telefonoEmp: { required: true }
			},
			messages: {
				apellido1: false,
				nombre: false,
