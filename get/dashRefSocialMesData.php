<?php
    ...
    //get number of rows
    $dashRefSocialMesSql = $con->query("SELECT SUM(ct.ct_costo) AS recaudo, ref.IDReferencia, ref.ref_nombre FROM referencias AS ref
                                ...
                                WHERE pcref.pc_idClinica = '$sessionClinica' AND pcref.pc_estado = '1' AND ct.ct_inicial = '1' AND ct.ct_mesCita = '$mesID' AND ct.ct_anoCita = '$hoyAno' AND ref.IDReferencia IN(1,2,3,4) 
...
<script type="text/javascript">
    ...
    $('#contRefSocial').show();
    $('#contRefSocial').html("<?php echo $arrayMeses[$IDmes].' | Redes Sociales' ?>");
</script>