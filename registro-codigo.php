...
<?php if($_SESSION['consultoriosLobbyMsj']==2){ ?>
	<div id="msj-login">
		...
		<label class="alerta exito" for="alertExito">
			<div>Se ha enviado un código de verificación al correo <b><?php echo $_SESSION['consultoriosRegistroCorreo']; ?></b>
				<br><br>
				<i>Recuerde revisar el Correo no deseado.</i></div>
		</label>
	</div>
	<form class="form" id="formCodigo" action="registro-cod-guardar.php" method="post">
