...
if(!$_POST['id']){
	$query = $con->query("INSERT INTO especialidades SET esp_idClinica='$sessionClinica', esp_nombre='$nombre', esp_estado='1', esp_fechaCreacion='$fechaHoy'");
	if($query){ $_SESSION['consultoriosExito']=2; } else { $_SESSION['consultoriosExito']=1; }
} else {
	$id = $_POST['id'];
	$query = $con->query("UPDATE especialidades SET esp_nombre='$nombre' WHERE IDEspecialidad='$id'");
