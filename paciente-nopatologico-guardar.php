...
$valNoPat = $_POST['valNoPat'];
$comentarioRip = nl2br(trim($_POST['comentarioRip']));

if($valNoPat>0){
  $query = $con->query("INSERT INTO pacientenopatologicos SET pnp_idPaciente='$pacienteID', pnp_idNoPatologico='$valNoPat', pnp_comentario='$comentarioRip', pnp_estado='1', pnp_fechaCreacion='$fechaHoy'");
