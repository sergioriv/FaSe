...
<form class="form" id="formPaciente" method="post" action="paciente-guardar.php" enctype="multipart/form-data">
	<div class="modal-header modal-header-form">
		...
		<?php if($id){ ?>
				        ...
				        <label for="tab-2" class="labelTab tab-paciente-antecedentes">Antecedentes</label>
...
<!--				        <input id="tab-9" type="radio" name="tab-group" />
				        <label for="tab-9" class="labelTab">DISPONIBLE</label>
				        <input id="tab-10" type="radio" name="tab-group" />
				        <label for="tab-10" class="labelTab">DISPONIBLE</label>
-->		<?php } ?>	
...
-->							<p>&nbsp</p>
		...
		<?php if($id){ ?>
						...
						<div class="divForm" id="content-2">
							...
							<div class="container3PartInput contRips" id="antecedentesCie10"></div>
						...
						<div class="divForm listAbonos" id="content-6">
							...
							$abonosPacienteNum = $con->query("SELECT * FROM abonos WHERE ab_idPaciente='$id'")->num_rows;
							?>
					                ...
					                ?>
					                    <div class="miniatura">                        
					                        ...
					                        <div class="optionImage">
					                          	<div class="ver-carousel-selector" data-img="<?php echo $imagenesRow['IDPacFoto'] ?>"><i class="fa fa-eye"></i></div>
